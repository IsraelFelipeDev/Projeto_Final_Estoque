...
namespace Projeto_FinalOficial
{
    public abstract class Usuario : Service
    {
            ...
            public virtual string NomeTabela { get; }
            public virtual string ChavePrimaria { get; }
            public abstract Dictionary<string, object> ObterParametros();
            public abstract Usuario ObterObjeto(MySqlDataReader reader);
